...
- Describe durable current behavior and link instead of duplicating another document.
- Keep README files as navigation; put behavioral guidance in the nearest `AGENTS.md`.
