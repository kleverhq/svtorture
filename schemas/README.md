...
`campaign-verdicts`, and `campaign-evidence` snapshots define the schema-v7
portable dashboard and Release resources; readers also accept schema v6. Regenerate all snapshots with `just
schemas`.
